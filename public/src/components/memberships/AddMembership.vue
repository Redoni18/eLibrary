        ...
        methods: {
            ...
            async addMembership() {
                this.$validator.validateAll().then( async (result) => {
                    if (result) {
                        await axios.post("http://localhost:8000/api/addMembership", {userType: this.selectedUserType, duration: this.membershipDuration, price: this.membershipPrice, description: this.membershipDescription, isPremium: this.membershipIsPremium})
